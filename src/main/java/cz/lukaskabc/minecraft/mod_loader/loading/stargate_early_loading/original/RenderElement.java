...
public class RenderElement extends net.neoforged.fml.earlydisplay.RenderElement {
...
//    }
    ...
    public record DisplayContext(int width, int height, int scale, ElementShader elementShader,
                                 ColourScheme colourScheme, PerformanceInfo performance) {
